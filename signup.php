    ...
    <div  class="signup-form">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="user_name" placeholder="Example: Bob"
            ...
            <div class="form-group">
                <label class="checkbox-inline"><input type="checkbox" required>I accespt the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            </div>
